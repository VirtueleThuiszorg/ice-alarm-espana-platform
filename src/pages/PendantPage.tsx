...
export default function PendantPage() {
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="pt-24 pb-16 relative overflow-hidden bg-gradient-to-b from-primary/5 via-background to-background">
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6 order-1 lg:order-2">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                <Button size="lg" className="h-14 px-8 text-lg shadow-lg bg-[hsl(var(--cta))] text-[hsl(var(--cta-foreground))] hover:bg-[hsl(30_92%_48%)]" asChild>
                  <Link to="/join">
                    {t("pendant.hero.cta")}
