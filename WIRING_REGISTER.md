...
- **failure shown to user** no
- **proof** none — capped at 6
- **routes** /, /admin, /admin/ai, /admin/ai-outreach, /admin/ai/agents/:agentKey, /admin/ai/operations +83
...
- **failure shown to user** no
- **proof** none — capped at 6
- **routes** /, /admin, /admin/ai, /admin/ai-outreach, /admin/ai/agents/:agentKey, /admin/ai/operations +95
...
- **failure shown to user** toast
- **proof** `src/test/checkoutPaymentMethods.test.ts`
- **routes** /, /admin, /admin/ai, /admin/ai-outreach, /admin/ai/agents/:agentKey, /admin/ai/operations +74
