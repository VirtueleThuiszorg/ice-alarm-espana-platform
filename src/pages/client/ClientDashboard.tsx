  ...
  return (
    <div className="space-y-6">
      ...
      */}
      ...
      {/*
        THE TWO CARDS A MEMBER OPENS THIS PAGE FOR, SIDE BY SIDE.

        Messages used to sit below Recent activity, which put it under the fold on a laptop —
        so the one card that can carry a question from our team was the one nobody scrolled to.
        Recent activity moves below the pair: its good state is empty, and an empty card does
        not need the top of the page.

        3fr/2fr rather than 1fr/1fr: a checklist rung is an uppercase label, a sentence and an
        action button on ONE line, and at half width they wrap. The checklist needs the wider
        half — which is also what "reduce the width of Your protection" was asking for.

        lg rather than md: below 1024px this stays one column. Two-up at tablet width leaves
        both halves too narrow, and this page is read on iPads by people in their seventies.

        items-start: without it the grid stretches both cards to equal height, and a short
        Messages card sits in a half-empty box beside a three-rung checklist.
      */}
