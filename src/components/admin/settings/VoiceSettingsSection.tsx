...
const PLACEHOLDERS: VoiceSettings = {
  voice_greeting_es: "Gracias por llamar a Care Conneqt. Soy Isabel, su asistente virtual.",
  voice_greeting_en: "Thank you for calling Care Conneqt Spain. I'm Isabel, your virtual assistant.",
