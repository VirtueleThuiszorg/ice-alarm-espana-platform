...
INSERT INTO public.testimonials (quote_en, quote_es, author_name, location_en, location_es, rating, page, display_order) VALUES
  -- Landing page
  ('The peace of mind this service gives our family is priceless. When Mum had a fall last month, help arrived within minutes. I can''t recommend Care Conneqt enough.',
   'La tranquilidad que este servicio da a nuestra familia no tiene precio. Cuando mamá tuvo una caída el mes pasado, la ayuda llegó en minutos. Recomiendo Care Conneqt sin reservas.',
  ...
  ('After my husband''s stroke, we needed reliable emergency support. Care Conneqt responded in under 30 seconds during a real emergency. They truly saved his life.',
   'Después del derrame de mi marido, necesitábamos apoyo de emergencia fiable. Care Conneqt respondió en menos de 30 segundos durante una emergencia real. Realmente le salvaron la vida.',
   'Susan & Peter Williams', 'Couple, Costa Blanca', 'Pareja, Costa Blanca', 5, 'landing', 3),
  -- Pendant page
  ('Care Conneqt gave me back my independence. I feel safe knowing help is just one button press away.',
   'Care Conneqt me devolvió mi independencia. Me siento seguro/a sabiendo que la ayuda está a solo un botón de distancia.',
  ...
  ('When my father fell, the pendant automatically called for help. The team was amazing and spoke to him in English. They saved his life.',
   ...
   'David', 'Son of Care Conneqt member', 'Hijo de miembro de Care Conneqt', 5, 'pendant', 2),
