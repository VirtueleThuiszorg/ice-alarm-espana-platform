...
192 distinct wires across 657 call sites and 110 routes.
...
|---|---|---:|
| `table` | `supabase.from(t).insert/update/upsert/delete` — a row written | 349 |
...
- **call sites** src/components/admin/member-detail/CourtesyCallsCard.tsx, src/components/admin/member-detail/ProfileTab.tsx, src/components/client/CompleteMyDetailsDialog.tsx, src/components/LanguageSelector.tsx +7
