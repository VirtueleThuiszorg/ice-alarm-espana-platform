  ...
  const faqs = [
    {
      ...
      answer: t("partnerSupport.faq1A", "You earn a commission for every person who signs up through your unique referral link and receives their ICE Alarm España pendant. Commissions are created automatically when the device is delivered."),
    },
    {
    ...
    },
    {
      ...
      answer: t("partnerSupport.faq7A", "ICE Alarm España currently operates in Spain and Portugal. Your referred customers must reside in these regions, but you can be based anywhere."),
    },
    {
